...
export interface AttributeInfo {
  name: string;
  /**
   * True if the property name appears in the flat attribute schema's top-level
 ...
 *
 * Walks the flat attribute schema's branches collecting `properties` entries.
 * Multiple descriptions of the same attribute keep the
