...
export default [
  ...
  ...treesitter,
  {
    ignores: [
      ...
      'js/parser/nodeTypes.generated.ts', // Generated by scripts/generate-ast-types.ts
    ],
  },
  {
    files: ['**/*.js', '**/*.mjs'],
  ...
  // TypeScript config for js/ and lsp/
  ...tseslint.config(
    {
      files: ['js/**/*.ts', 'lsp/**/*.ts', 'scripts/**/*.ts'],
    ...
    {
      files: ['js/cli/check.ts', 'js/cli/check.test.ts'],
      rules: {
